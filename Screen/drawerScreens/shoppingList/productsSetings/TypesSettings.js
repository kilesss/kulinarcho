...
class TypesSettings extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.focusListener = navigation.addListener('didFocus', async () => {
      ...
      if (route === null) {
        arrRoute.push('TypesSettings')
      } else {
        arrRoute = route
      }
      if (arrRoute[arrRoute - 1] != 'TypesSettings') {
        arrRoute.push('TypesSettings')
      }    
  ...
  _saveDetails = (prop) => {
    ...
    this.setState({ modalEditTitle: 'Добавяне на категория' });
          ...
          <View>
            ...
            <View style={styles.item}>
              ...
              <Icon style={styles.icon}
                size={30}
                onPress={() => {
                  this.setState({ modalEditTitle: 'Редактиране на категория' });
        ...
        <View style={styles.MainContainer}>
          ...
          >
            ...
            <TextInput
              ...
              onSubmitEditing={() => {                 this.submitEditType();
                this.RBSheet2.close();
                this.RBSheet.close(); }}
              blurOnSubmit={false}
          ...
          <View style={styles.topView}>
            ...
            >
              <Text style={styles.customBtnBGTop}>Продукти</Text>
            ...
            >
              <Text style={{ ...styles.customBtnBGTop, color: 'green' }}>Категории</Text>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <View style={styles.modalHeader}>
                  <Text style={styles.titlem}>Изтриване на категория</Text>
                  <View style={styles.dividerm}></View>
                </View>
                <Text style={{
                  justifyContent: "center",
                  alignItems: "center", marginLeft: 20
                }}>Сигурни ли сте че искате да изтриете категорията <Text style={{ fontStyle: "italic", fontWeight: "bold" }}>{deleteType}</Text></Text>
